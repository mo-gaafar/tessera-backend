 ...
 * @param {Object} req - The request object containing the ticket's info
...

{
    ...
    const {eventID,ticketID,purchasePrice,ticketTier} =req.body; 
...
module.exports = { createTicket,editTicket };
