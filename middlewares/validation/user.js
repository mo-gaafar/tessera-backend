...
exports.validateUserSignup=[
  ...
  check('firstName').trim().not().isEmpty().withMessage('First Name is Required').isLength({min:3,max:20}).withMessage('First Name must be within 3 to 20 char').isAlpha().withMessage('First Name should contain letters only'),
  check('lastName').trim().not().isEmpty().withMessage('Last Name is Required').isLength({min:3,max:20}).withMessage('Last Name must be within 3 to 20 char').isAlpha().withMessage('Last Name should contain letters only'),
